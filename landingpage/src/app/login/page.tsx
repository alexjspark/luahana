            ...
            <div className="glass p-8 sm:p-12 max-w-md w-full rounded-3xl border border-white/10 shadow-2xl backdrop-blur-xl relative">
                ...
                <div className="relative z-10 flex flex-col gap-4">
                    ...
                    <form action={signInWithApple}>
                        <button
                            type="submit"
                            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-black text-white hover:text-white rounded-xl font-medium hover:bg-slate-900 transition-all active:scale-[0.98] shadow-md border border-slate-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-slate-900"
                        >
